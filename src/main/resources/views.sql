...
CREATE VIEW IF NOT EXISTS v_qtd_produto_por_condominio AS
SELECT
...
CREATE VIEW IF NOT EXISTS v_qtd_produtos_n_conforme_por_condominio AS
SELECT
    condominio.id AS condominio_id,
...
CREATE VIEW IF NOT EXISTS v_qtd_produtos_vencidos_por_condominio AS
SELECT
    condominio.id AS condominio_id,
    condominio.nome AS nome_condominio,
...
CREATE VIEW IF NOT EXISTS v_qtd_discrepancia_condominios AS
SELECT
    condominio.nome AS nome_condominio,
...
CREATE VIEW IF NOT EXISTS v_total_produtos_arrecadados_por_mes AS
SELECT
...
CREATE VIEW IF NOT EXISTS v_total_produtos_arrecadados_por_mes_condominio AS
SELECT
    condominio.id AS condominio_id,
    DATE_FORMAT(produto_unitario.criado_em, '%Y-%m') AS mes,
    COUNT(produto_unitario.id) AS count
...
CREATE VIEW IF NOT EXISTS v_qtd_produtos_por_nome_condominio AS
SELECT
    condominio.nome AS nome_condominio,
    DATE_FORMAT(produto_unitario.criado_em, '%Y-%m') AS mes,
    COUNT(produto_unitario.id) AS count
...
CREATE VIEW IF NOT EXISTS v_qtd_total_alimentos_arrecadados_por_mes AS
SELECT
...
CREATE VIEW IF NOT EXISTS v_qtd_produto_por_campanha AS
SELECT
...
CREATE VIEW IF NOT EXISTS v_qtd_produtos_vencidos_por_campanha AS
SELECT
    campanha.id as campanha_id,
    campanha.local_campanha + produto_unitario.nome AS nome,
    produto_unitario.produto_id,
...
CREATE VIEW IF NOT EXISTS v_qtd_doacoes_por_campanha AS
SELECT
...
CREATE VIEW IF NOT EXISTS v_produtos_conforme_nao_conforme_campanhas AS
SELECT
    c.local_campanha + pu.nome AS nome,
